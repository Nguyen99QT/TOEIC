...
Write-Host "=== Testing Login with Teacher Credentials ===" -ForegroundColor Cyan

# Test login với teacher user
$loginData = @{
    username = "teacher"
    password = "password"
} | ConvertTo-Json

Write-Host "1. Testing login with teacher/password..." -ForegroundColor Yellow
try {
