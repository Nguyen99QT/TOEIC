-- Create question_groups table without foreign key constraint first
...
ALTER TABLE questions ADD COLUMN group_id BIGINT DEFAULT NULL;

-- Insert question groups for Parts 6 & 7
INSERT IGNORE INTO question_groups (part_number, test_id, content, title, created_at, updated_at) VALUES 
(6, 2, 'Windsor Regional Bank is pleased to announce the opening of our newest branch office in downtown Windsor. This expansion represents our continued commitment to serving the financial needs of the Windsor community. Our new location features modern facilities, convenient parking, and extended hours to better serve our customers. We have hired experienced staff members who are fluent in both English and French to provide excellent customer service. The Windsor branch will offer all of our standard banking services, including personal and business accounts, loans, and investment services. We look forward to welcoming new customers and continuing to serve our existing clients in this vibrant community.', 'Bank Branch Opening Announcement', NOW(), NOW()),
...
All new employees will be required to complete this program within their first 90 days. Current employees who wish to participate in the professional development workshops may register through the HR portal. Please contact me if you have any questions about this exciting new initiative.', 'Employee Training Program Memo', NOW(), NOW());
...
WHERE tq.test_id = 2 AND tq.part_number = 6;
...
WHERE tq.test_id = 2 AND tq.part_number = 7;
