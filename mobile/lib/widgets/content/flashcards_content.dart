...
class FlashcardsScreenContent extends StatefulWidget {
  const FlashcardsScreenContent({super.key});

  @override
  State<FlashcardsScreenContent> createState() =>
      _FlashcardsScreenContentState();
}

class _FlashcardsScreenContentState extends State<FlashcardsScreenContent> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _buildStatColumn(
                        'Cards Mastered',
                        _flashcardSets
                            .fold<int>(0, (sum, set) => sum + set.masteredCount)
                            .toString(),
